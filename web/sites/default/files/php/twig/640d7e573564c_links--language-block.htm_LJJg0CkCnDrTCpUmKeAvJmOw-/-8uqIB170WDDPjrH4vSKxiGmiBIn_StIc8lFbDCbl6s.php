...
/* themes/custom/server_theme/templates/links--language-block.html.twig */
class __TwigTemplate_cb9fbc3d427e1a65e23f88d58db6113268e1d2e440cd98818725bcf024f5d53d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (($context["links"] ?? null)) {
            ...
            // line 44
            echo "<ul";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "flex flex-row justify-end gap-x-4"], "method", false, false, true, 44), 44, $this->source), "html", null, true);
            echo ">";
            // line 45
...
$context["item"], "text_attributes", [], "any", false, false, true, 49)) {
    ...
    {
        return "themes/custom/server_theme/templates/links--language-block.html.twig";
    }
...
{% if links -%}
  {%- if heading -%}
    ...
    {%- endif -%}
  {%- endif -%}
  <ul{{ attributes.addClass('flex flex-row justify-end gap-x-4') }}>
    {%- for item in links -%}
      <li{{ item.attributes }}>
        {%- if item.link -%}
          {{ item.link }}
...
{%- endif %}
", "themes/custom/server_theme/templates/links--language-block.html.twig", "/var/www/html/web/themes/custom/server_theme/templates/links--language-block.html.twig");
    }
